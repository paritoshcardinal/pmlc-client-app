(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pie-controller-pie-item"] = factory();
	else
		root["pie-controller-pie-item"] = factory();
...
var Stack = __webpack_require__(29),
    ...
    baseAssignIn = __webpack_require__(119),
...
var partialScoring = _interopRequireWildcard(__webpack_require__(184));

exports.partialScoring = partialScoring;

var _persistence = __webpack_require__(186);
...
var baseRandom = __webpack_require__(189);
...
exports['categorize-el'] = __webpack_require__(71);
exports['multiple-choice'] = __webpack_require__(195);
...
exports.createCorrectResponseSession = exports.outcome = exports.model = exports.normalize = exports.createDefaultModel = exports.getCorrectness = exports.getTotalScore = exports.getPartialScore = void 0;

var _regenerator = _interopRequireDefault(__webpack_require__(38));

var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(39));

var _defineProperty2 = _interopRequireDefault(__webpack_require__(40));

var _isEmpty = _interopRequireDefault(__webpack_require__(22));

var _categorize = __webpack_require__(87);

var _feedback = __webpack_require__(183);

var _controllerUtils = __webpack_require__(68);

var _defaults = _interopRequireDefault(__webpack_require__(194));
...
var getTotalScore = function getTotalScore(question, session, env) {
  ...
  var hasAlternates = correctResponse.map(function (c) {
...
var createDefaultModel = function createDefaultModel() {
  ...
  return new Promise(function (resolve) {
    resolve(_objectSpread({}, _defaults["default"], {}, model));
  });
};
...
var model = function model(question, session, env, updateSession) {
  ...
  function () {
    ...
    _regenerator["default"].mark(function _callee(resolve) {
      var normalizedQuestion, answerCorrectness, _ref7, mode, role, categories, categoriesPerRow, choicesPerRow, choicesLabel, choicesPosition, correctResponse, feedback, feedbackEnabled, lockChoiceOrder, promptEnabled, prompt, removeTilesAfterPlacing, rowLabels, rationaleEnabled, rationale, teacherInstructionsEnabled, teacherInstructions, choices, fb, out;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              answerCorrectness = getCorrectness(normalizedQuestion, session, env);
              _ref7 = env || {}, mode = _ref7.mode, role = _ref7.role;
              categories = normalizedQuestion.categories, categoriesPerRow = normalizedQuestion.categoriesPerRow, choicesPerRow = normalizedQuestion.choicesPerRow, choicesLabel = normalizedQuestion.choicesLabel, choicesPosition = normalizedQuestion.choicesPosition, correctResponse = normalizedQuestion.correctResponse, feedback = normalizedQuestion.feedback, feedbackEnabled = normalizedQuestion.feedbackEnabled, lockChoiceOrder = normalizedQuestion.lockChoiceOrder, promptEnabled = normalizedQuestion.promptEnabled, prompt = normalizedQuestion.prompt, removeTilesAfterPlacing = normalizedQuestion.removeTilesAfterPlacing, rowLabels = normalizedQuestion.rowLabels, rationaleEnabled = normalizedQuestion.rationaleEnabled, rationale = normalizedQuestion.rationale, teacherInstructionsEnabled = normalizedQuestion.teacherInstructionsEnabled, teacherInstructions = normalizedQuestion.teacherInstructions;
              ...
              _context.next = 8;
              return (0, _feedback.getFeedbackForCorrectness)(answerCorrectness.correctness, feedback);
...
exports.buildState = exports.buildCategories = exports.getAllPossibleResponses = exports.getBuiltCategories = exports.buildChoices = exports.stillSelectable = exports.moveChoiceToCategory = exports.removeChoiceFromCategory = exports.removeAllChoices = exports.removeCategory = exports.countChosen = exports.countInChoices = exports.countInAnswer = exports.ensureNoExtraChoicesInAnswer = exports.limitInArray = exports.limitInArrays = exports.limitChoices = exports.FooTwo = void 0;

var _compact = _interopRequireDefault(__webpack_require__(88));

var _debug = _interopRequireDefault(__webpack_require__(47));

var _clone = _interopRequireDefault(__webpack_require__(92));

var _cloneDeep = _interopRequireDefault(__webpack_require__(139));

var _remove = _interopRequireDefault(__webpack_require__(140));

var _every = _interopRequireDefault(__webpack_require__(173));

var _isEqual = _interopRequireDefault(__webpack_require__(66));

var _isUndefined = _interopRequireDefault(__webpack_require__(67));

var _scoring = __webpack_require__(182);
...
var log = (0, _debug["default"])('@pie-lib:categorize');

var limitChoices = function limitChoices(choiceId, count, choices) {
  var out = choices.reduce(function (acc, id) {
    var foundCount = countInChoices(choiceId, acc.choices); // log('[limitChoices] choiceId: ', choiceId, '  foundCount: ', foundCount);
...
exports.limitChoices = limitChoices;

var limitInArrays = function limitInArrays(id, arrays, limit) {
  arrays = arrays || [];
...
exports.limitInArrays = limitInArrays;

var limitInArray = function limitInArray(id, arr, limit) {
  arr = arr || [];
...
exports.limitInArray = limitInArray;

var ensureNoExtraChoicesInAnswer = function ensureNoExtraChoicesInAnswer(answer, choices) {
  choices = choices || [];
  var out = choices.reduce(function (answerArray, choice) {
    log('choice: ----> ', choice.id, 'categoryCount: ', choice.categoryCount); // log('answer array: ', answerArray);
...
exports.ensureNoExtraChoicesInAnswer = ensureNoExtraChoicesInAnswer;

var countInAnswer = function countInAnswer(choiceId, answer) {
...
exports.countInAnswer = countInAnswer;

var countInChoices = function countInChoices(choiceId, choices) {
...
exports.countInChoices = countInChoices;

var countChosen = function countChosen(choice, categories) {
  if (!choice || !choice.id) {
    return 0;
  }
...
exports.countChosen = countChosen;

var removeCategory = function removeCategory(categoryId, answers) {
...
var removeAllChoices = function removeAllChoices(choiceId, answers, categoryId) {
  return answers.map(function (a) {
    if (!categoryId || a.category === categoryId) {
      var cloned = (0, _clone["default"])(a.choices);
      (0, _remove["default"])(cloned, function (v) {
        return v === choiceId;
      });
...
exports.removeAllChoices = removeAllChoices;

var removeChoiceFromCategory = function removeChoiceFromCategory(choiceId, categoryId, choiceIndex, answers) {
...
exports.removeChoiceFromCategory = removeChoiceFromCategory;

var moveChoiceToCategory = function moveChoiceToCategory(choiceId, from, to, choiceIndex, answers) {
...
exports.moveChoiceToCategory = moveChoiceToCategory;

var stillSelectable = function stillSelectable(h, builtCategories) {
  if (h.categoryCount > 0) {
    var count = countChosen(h, builtCategories);
...
exports.stillSelectable = stillSelectable;

var buildChoices = function buildChoices(possibleResponseChoices, builtCategoryChoices) {
  return builtCategoryChoices.reduce(function (acc, builtChoice) {
    // set correct value on each choice that was selected by user
    var index = acc.copyOfPossibleResponse.findIndex(function (cRC) {
      return cRC === builtChoice.id;
    }); // if the choice exists in the correct response
    // set the correct: true

    if (index >= 0) {
      acc.builtChoices.push(_objectSpread({}, builtChoice, {
        correct: true
      }));
      acc.copyOfPossibleResponse = [].concat(_toConsumableArray(acc.copyOfPossibleResponse.slice(0, index)), _toConsumableArray(acc.copyOfPossibleResponse.slice(index + 1)));
    } else {
      acc.builtChoices.push(_objectSpread({}, builtChoice, {
        correct: false
      }));
    ...
    builtChoices: [],
    copyOfPossibleResponse: _toConsumableArray(possibleResponseChoices),
...
var getBuiltCategories = function getBuiltCategories(possibleResponse, builtCategories) {
  return builtCategories.reduce(function (acc, builtCategory) {
    var possibleResponseChoices = possibleResponse[builtCategory.id] || []; // the correct choices for this category

    var builtCategoryChoices = builtCategory.choices || []; // the choices in the answer

    var _buildChoices = buildChoices(possibleResponseChoices, builtCategoryChoices),
        builtChoices = _buildChoices.builtChoices,
        allChoicesAreCorrect = _buildChoices.allChoicesAreCorrect;

    var allChoicesAreInAnswer = builtCategoryChoices.length === possibleResponseChoices.length;
    acc.builtCategories.push(_objectSpread({}, builtCategory, {
...
exports.getBuiltCategories = getBuiltCategories;

var getAllPossibleResponses = function getAllPossibleResponses(correctResponse) {
  if (!correctResponse) {
    return [];
  }

  return correctResponse.reduce(function (acc, cR) {
    // main response
    if (acc[0]) {
      acc[0][cR.category] = cR.choices;
    } else {
      acc.push(_defineProperty({}, cR.category, cR.choices));
    } // alternate responses


    if (cR.alternateResponses) {
      cR.alternateResponses.forEach(function (aR, index) {
        if (acc[index + 1]) {
          acc[index + 1][cR.category] = aR;
        } else {
          acc.push(_defineProperty({}, cR.category, aR));
        }
      });
    }
...
exports.getAllPossibleResponses = getAllPossibleResponses;

var buildCategories = function buildCategories(categories, choices, answers) {
  categories = categories || [];
  answers = answers || [];
  choices = choices || [];
  return categories.map(function (category) {
    var answer = answers.find(function (answer) {
      return answer.category === category.id;
    });

    var _ref = answer || {},
        _ref$choices = _ref.choices,
        answerChoices = _ref$choices === void 0 ? [] : _ref$choices;

    return _objectSpread({}, category, {
      choices: answerChoices.map(function (chId) {
...
var buildState = function buildState(categories, choices, answers, correctResponse) {
  categories = categories || [];
  choices = choices || [];
  answers = answers || [];
  var allResponses = getAllPossibleResponses(correctResponse) || [];
  var builtCategories = buildCategories(categories, choices, answers);
  var bestResponse;
  var entirelyCorrect; // at least one defined correct response

  if (allResponses.length) {
    var builtData = allResponses.reduce(function (acc, possibleResponse) {
      // set correctness for each possible response
      var _getBuiltCategories = getBuiltCategories(possibleResponse, builtCategories),
          categoriesWithChoices = _getBuiltCategories.builtCategories,
          correct = _getBuiltCategories.correct; // if bestResponse not found yet OR no correct response found yet and this one is the correct one
  ...
  var filteredChoices = choices.map(function (ch) {
    return stillSelectable(ch, builtCategories) ? ch : {
      empty: true
    };
  });
  return {
...
var getTag = __webpack_require__(6),
    isObjectLike = __webpack_require__(4);
...
var baseIteratee = __webpack_require__(61),
    basePullAt = __webpack_require__(168);
...
var baseUnset = __webpack_require__(169),
    isIndex = __webpack_require__(20);
...
var arrayEvery = __webpack_require__(174),
...
var log = (0, _debug["default"])('@pie-lib:categorize:scoring');
...
var score = function score(categories, scoring) {
  return new Promise(function (resolve) {
...
var _lodash = _interopRequireDefault(__webpack_require__(185));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(45), __webpack_require__(13)(module)))
...
exports.getShuffledChoices = exports.compact = void 0;

var _shuffle = _interopRequireDefault(__webpack_require__(187));

var _isEmpty = _interopRequireDefault(__webpack_require__(22));

var _isNull = _interopRequireDefault(__webpack_require__(193));
...
var getShuffledChoices = function getShuffledChoices(choices, session, updateSession, key) {
  return new Promise(function (resolve) {
      ...
      if (updateSession && typeof updateSession === 'function') {
        try {
          ...
          if ((0, _isEmpty["default"])(shuffledValues)) {
            error("shuffledValues is an empty array? - refusing to call updateSession: shuffledChoices: ".concat(JSON.stringify(shuffledChoices), ", key: ").concat(key));
          } else {
...
var arrayShuffle = __webpack_require__(188),
    baseShuffle = __webpack_require__(190),
    isArray = __webpack_require__(0);
...
var copyArray = __webpack_require__(53),
    shuffleSelf = __webpack_require__(69);
...
var shuffleSelf = __webpack_require__(69),
...
exports.model = model;
exports.outcome = outcome;
exports.createCorrectResponseSession = exports.getScore = exports.normalize = void 0;
...
var _defaults = _interopRequireDefault(__webpack_require__(197));
...
function createDefaultModel() {
  var model = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return new Promise(function (resolve) {
    return resolve(_objectSpread({}, _defaults["default"], {}, model));
  });
}

var normalize = function normalize(question) {
  return _objectSpread({}, _defaults["default"], {}, question);
};
/**
 *
 * @param {*} question
...
function _model() {
  _model = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee(question, session, env, updateSession) {
    var normalizedQuestion, defaultFeedback, choices, out, _ref3, role, mode;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            _ref3 = env || {}, role = _ref3.role, mode = _ref3.mode;
