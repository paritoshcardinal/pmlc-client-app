...
window.EquationEditor = {}, EquationEditor.Events = {
    on: function (t, n, o) {
        var e;
        return this._events || (this._events = {}), (e = this._events)[t] || (e[t] = []), this._events[t].push({ callback: n, context: o || this })
    }, trigger: function (t) {
        var n, o;
        if (this._events)
            return n = Array.prototype.slice.call(arguments, 1), (o = this._events[t]) ? this.triggerEvents(o, n) : void 0
    }, triggerEvents: function (t, n) {
        var o, e, i, r, u;
        for (u = [], e = 0, i = t.length; i > e; e++)
            o = t[e], u.push((r = o.callback).call.apply(r, [o.context].concat(__slice.call(n))));
        return u
    }
...
EquationEditor.CollapsibleView = function (t) {
    ...
    return __extends(n, t), n.prototype.initialize = function () {
        var ss = this;
        if (isFirst) {
            setTimeout(function () { ss.$(".accordion-heading").trigger('click'); }, 200);
            isFirst = false;
        }
        return this.$(".accordion-heading").on("click", this.toggleCollapse)
    }, n.prototype.toggleCollapse = function (t) {
        return t.preventDefault(), this.$(".accordion-body").hasClass("collapse") ? this.openCollapsible() : this.closeCollapsible()
    }, n.prototype.openCollapsible = function () {
        return this.$(".accordion-body").removeClass('collapse'), this.toggleOpenClass()
    }, n.prototype.closeCollapsible = function () {
        return this.$(".accordion-body").addClass('collapse'), this.toggleOpenClass()
    }, n.prototype.toggleOpenClass = function () {
        return this.$(".accordion-toggle").toggleClass("collapsed")
    }, n
}(EquationEditor.View);
var __bind = function (t, n) {
    return function () {
...
EquationEditor.Buttons = {}, EquationEditor.Buttons.BaseButtonView = function (t) {
    ...
    return __extends(n, t), n.prototype.initialize = function () {
        return this.latex = this.options.latex, this.buttonText = this.options.buttonText || this.options.latex, this.tooltipText = this.options.tooltipText || this.buttonText, this.tooltipDir = this.options.tooltipDir || 'bottom', this.className = ["math-button", this.options.className].join(" ").trim()
        ...
        return '<div class="' + this.className + '">\n  <a class="ee-button btn eq-editor-tip" title="' + this.tooltipText + '" data-placement="' + this.tooltipDir + '" href="#">' + this.buttonText + "</a>\n</div>"
    }, n
...
EquationEditor.ButtonGroupView = function (t) {
    ...
    return __extends(n, t), n.prototype.initialize = function () {
        ...
        var t, n, o, e, i;
        for (e = this.buttonViews, i = [], n = 0, o = e.length; o > n; n++)
            t = e[n], i.push(this.$(".buttons").append(t.render().$el));
        return i
    }, n.prototype.template = function () {
        return '<div class="accordion-group simbol-block-holder accordion">\n  <div class="accordion-heading">\n    <a class="accordion-toggle collapsed" href="#">' + this.groupName + '</a>\n</div>\n<div class="accordion-body collapse">\n<div class="accordion-inner buttons clearfix"></div>\n</div>\n</div>';
    }, n
}(EquationEditor.View), EquationEditor.ButtonViewFactory = {
    create: function (config) {
        var buttonConfig, buttons, klass, _i, _len;
        for (buttons = [], _i = 0, _len = config.length; _len > _i; _i++)
            buttonConfig = config[_i], klass = eval(buttonConfig.klass), buttons.push(new klass(buttonConfig));
        return buttons
    }
    ...
    create: function (t) {
        ...
        for (o = [], e = 0, i = t.length; i > e; e++)
            n = t[e], n.buttonViews = EquationEditor.ButtonViewFactory.create(n.buttonViews), o.push(new EquationEditor.ButtonGroupView(n));
        return o
    }
};
...
Buttons = EquationEditor.Buttons, ButtonGroup = EquationEditor.ButtonGroupView, EquationEditor.EquationEditorView = function (t) {
    ...
    return __extends(n, t), n.prototype.initialize = function () {
        ...
        return $.getJSON("config.js").done(function (t) {
            return function (n) {
        ...
        var t, n, o, e, i;
        for (e = this.buttonBarButtons(), i = [], n = 0, o = e.length; o > n; n++)
            t = e[n], i.push(this.$(".button-bar").append(t.render().$el));
        return i
    }, n.prototype.addButtonGroups = function () {
        var t, n, o, e, i;
        for (e = this.buttonGroups(), i = [], n = 0, o = e.length; o > n; n++)
            t = e[n], i.push(this.$(".button-groups").append(t.render().$el));
        return i
