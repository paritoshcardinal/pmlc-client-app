	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function onFileChange(e) {
	      ...
	      if (this.$fileInput.get(0).files && this.$fileInput.get(0).files.length>0) {
              if ((this.$fileInput.get(0).files[0].size < this.options.maxImageSizeInBytes) || this.options.allowAnyImageSizeToUpload) {
	...
	var Zoomer = (function () {
	  ...
	  _createClass(Zoomer, [{
	    ...
	    value: function setup(_ref) {
	      ...
	      if (smallImage === 'allow') {
	          ////"PML customize detail: Need to comment, to allow small image zooming."
...
/***/ function(module, exports, __webpack_require__) {
	...
	var options = {
      ...
      {
          ////"PML customize detail: maxImageSizeInBytes property sets the required maximum image size in bytes."
          name: 'maxImageSizeInBytes',
          type: 'number',
          description: 'required maximum image size in bytes.',
          'default': 1
        },
      {
        ////"PML customize detail: allowAnyImageSizeToUpload property sets to allow any size of image to be upload in bytes."
        name: 'allowAnyImageSizeToUpload',
        type: 'boolean',
        description: 'Allow Any Size of Image to upload.',
        'default': false
      },{
