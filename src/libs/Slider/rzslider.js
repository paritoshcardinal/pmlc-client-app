...
(function (root, factory) {
        ...
        Slider.prototype = {
            ...
            init: function () {
                ...
                this.scope.$on('rzSliderForceRender', function () {
                    ...
                    self.resetSlider();
                    $timeout(function () {
                                   if (parseInt($('.rz-green')[0].style.left) > 0) {
                                       var wdth = parseInt($('.rz-green')[0].style.left) + 1;
                                       $('.rz-barsss').css('z-index', '2');
                                       $('.rz-barsss').width(wdth);
            ...
            callOnMove: function () {
                if (this.scope.rzSliderOnMove) {
                    var self = this;
                    $timeout(function () {
                        self.scope.rzSliderOnMove();
                    });
                }
            },
            callOnInit: function () {
                if (this.scope.rzSliderOnInit) {
                    var self = this;
                    $timeout(function () {
                        self.scope.rzSliderOnInit();
                    });
                }
            },
            ...
            onMove: function (pointer, event) {
                ...
                // this.maxH.rzsv="%"
                //if ($(".rz-setPerMin").text().indexOf('%') <= 0) {
                //    $(".rz-setPerMin").append("%");
                //}
                //if ($(".rz-setPerMax").text().indexOf('%') <= 0) {
                //    $(".rz-setPerMax").append("%");
                //  }   
                //console.log(this.maxLab.rzsv);
            },
    ...
    module.run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('rzSliderTpl.html',
          "<span class=rz-bar-wrapper><span class=rz-bar></span><span class=rz-barsss></span></span> <span class=rz-bar-wrapper><span class=\"rz-bar rz-selection\"></span></span> <span class=\"rz-pointer rz-green\"></span> <span class=rz-pointer></span> <span class=\"rz-bubble rz-limit min-limit\"></span> <span class=\"rz-bubble rz-limit max-limit\"></span> <span class=\"rz-bubble rz-setPerMin\"></span> <span class=\"rz-bubble rz-setPerMax\"></span> <span class=rz-bubble></span><ul class=rz-ticks></ul>"
        );
