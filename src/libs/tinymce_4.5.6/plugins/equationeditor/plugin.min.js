tinymce.create("tinymce.plugins.EquationEditorPlugin", {
    init: function (t, e) {
        ...
        return n = null, t.addCommand("mceMathquill", function (i) {
            if (tinymce.Env.ie) {                               
                $('#myModalRenderPlaylistDetails').removeClass('modal');
                $('#myModalRenderPlaylistDetails').removeClass('playwindowPosition');                
                $('#myModalRenderPlaylistDetails').removeAttr('tabindex');
                $('#addRubricKeyPopup').removeClass('modal-medium');
            }

            var r;
            return i || (i = ""), r = t.windowManager.open({
                url: "/Scripts/libs/tinymce_4.5.6/equation_editor.html",
                width: 820,
                height: 400,
                inline: 1,
                popup_css: !1,
                ...
                onClose: function (e) {
                    if (tinymce.Env.ie) {                       
                        $('#myModalRenderPlaylistDetails').addClass('modal');
                        $('#myModalRenderPlaylistDetails').attr('tabindex', '-1');
                        $('#myModalRenderPlaylistDetails').addClass('playwindowPosition');                        
                        $('#addRubricKeyPopup').addClass('modal-medium');
                    }
                },
                buttons: [{
                    text: "insert",
            ...
            else return n && t.selection.select(n), n = null, t.selection.setContent(e);
        }), t.on("init", function () {
